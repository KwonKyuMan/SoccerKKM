	...
	<tr>
		...
		<td width=890  valign=top>
			<table border=0>
				...
				<tr>
					<td style="font-size:18px;font-weight:bold;width:100%" colspan=5><%=bbs_title%></td>
				</tr>
				<tr>
				...
				<tr>
					<td height=10 colspan=2>total : <%=total_record %>
					</td>
				...
				<tr>
					<td height=10 colspan=5 style="border-bottom:1px solid gray"></td>
				</tr>
				<tr>
					<td width=50 align=center style="padding-top:15px;padding-bottom:15px;font-size:13px;border-bottom:1px solid gray">번호</td>
					<td width=40 style="font-size:13px;border-bottom:1px solid gray"></td>
					<td width=600 align=center style="font-size:13px;border-bottom:1px solid gray" >제목</td>
				...
				<tr> 
					...
					<td width=40  class="e">
					<%if(file1_s.equals("")){ %>
						<font color = red style="font-size:13px">[NO]</font>
					<%}else{%>
						<img src="/upload/<%=file1_s%>" width=38>
					<%} %>
					</td>
			...
			<table width="700" border="0">
				<tr>
					...
					<td align=right width=200>
						...
						<a href="/champions3/write.jsp?code=<%=code%>">[글쓰기]</a>
						<%}else{ %>
						[로그인 후 작성하실 수 있습니다.]
						<%} %>
					</td>
