	...
	<tr>
		...
		<td width=890  valign=top>
			<table border=0>
				...
				<tr>
					<td align=center style="padding-top:15px;padding-bottom:15px;font-size:18px;border-bottom:1px solid gray;font-weight:bold" colspan=4>시즌 별 챔스 우승팀</td>
				</tr>
				<tr>
			...
			<table width="700" border="0">
				<tr>
					...
					<td align=right width=200>
						...
						<a href="/champions/write.jsp?code=<%=code%>">[글쓰기]</a>
						<%}else{ %>
						[관리자만 작성하실 수 있습니다.]
						<%} %>
					</td>
