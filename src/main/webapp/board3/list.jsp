	...
	<tr>
		...
		<td width=890  valign=top>
			<table border=0>
				...
				<tr>
					<td align=center style="padding-top:15px;padding-bottom:15px;font-size:18px;border-bottom:1px solid gray" colspan=4>자유 갤러리</td>
				</tr>
				<tr>
				...
				while(rs2.next()){
					...
					<%} %>
						<td width=175>
							<table width=100%>
								<tr>
									<td align=center><a href="/board3/view.jsp?code=<%=code%>&uid=<%=uid%>&page_now=<%=page_now%>"><img src="/upload/<%=file1_s%>" width=200 height=200></a></td>
								</tr>
							</table>
							<table>
								<tr>
									<td align =center><a href="/board3/view.jsp?code=<%=code%>&uid=<%=uid%>&page_now=<%=page_now%>" style="color:pink;font-weight:bold;font-size:16px"><%=subject %></a></td>
								</tr>
							</table>
						</td>
					<%if(i % 4 == 3){ %>
			...
			<table width="700" border="0">
				<tr>
					...
					<td align=right width=200>
						...
						<a href="/board3/write.jsp?code=<%=code%>">[글쓰기]</a>
						<%}else{ %>
						[로그인 후 작성하실 수 있습니다.]
						<%} %>
					</td>
